...
class StepsTemperatureTrigger(private val triggers: List<Trigger>) : Trigger {

    private val notificationTitle: String
    private val notificationMessage: String

    init {
        notificationTitle = "StepsTemperature Trigger"
        notificationMessage = "You’ve not completed many steps for today. It’s warm outside and your battery is charged go for a walk."
    }
